...
namespace Test_Automation_Selenium_NUnit
{
    public static class JSONDataReader
    {
        ...
        public static TestData_Trello TestData { get; }

        //public static string SourceName;
        public static string Text_Home_WelCome;
        ...
        public static string Text_Registration;
        ...
        static JSONDataReader()
        {
            ...
            //Read Test Data file
            string ReadTestData = System.IO.File.ReadAllText(assemblyPath + "\\TestData\\TestData_Trello.json");

            //De serelize the Test Data File
            TestData = JsonConvert.DeserializeObject<TestData_Trello>(ReadTestData);

            #region Get_Test_Data_Files_Variables

            Text_Home_WelCome = TestData.Text_Home_WelCome;
            Attachment1 = TestData.Attachment1;
            Attachment2 = TestData.Attachment2;
            Getting_Started = TestData.Getting_Started;
            Main_Heading = TestData.Main_Heading;
            Text_Registration = TestData.Text_Registration;
